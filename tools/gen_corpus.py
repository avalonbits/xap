...
# The image is eight banks of 8K, which is the whole address space, so what
# actually binds is the program counter: the corpus is assembled at $1000 and
# an object that ran past $FFFF would wrap it. Saying so here is better than
# an out-of-memory error from the far end.
IMAGE_LIMIT = 0x10000 - 0x1000
